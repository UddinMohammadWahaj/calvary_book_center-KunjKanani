        ...
        children: [
          ...
          TextFormField(
            ...
            controller: Get.find<ProductReviewController>()
                .reviewTitleTextFieldController,
          ...
          TextFormField(
            controller:
                Get.find<ProductReviewController>().reviewTextFieldController,
            onSaved: (review) {},
            // validator: RequiredValidator(errorText: "This field is required"),
            maxLines: 5,
              ...
              return ElevatedButton(
                onPressed: () {
                  ...
                  if (formKey.currentState!.validate()) {
                    Get.find<ProductReviewController>().createReview();
                  }
                },
                child: controller.isCreatingReview.value
